...
public class MultiplicationTest {
    ...
    void testConstant() {
        // given
        Expression multiplicationOfVariousExpressionsAsExpression = new Multiplication(new Constant(10),
            new Negate(new Constant(20)));
        // when
        double multiplicationOfVariousExpressionsAsPrimitive = multiplicationOfVariousExpressionsAsExpression.evaluate();
        // then
